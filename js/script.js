...
(function (d) {
  ...
  $(function () {
    ...
    ScrollReveal().reveal(
      ".works__portfolio, .works__salon, .works__designcafe, .works__workers, .works__humberger, .works__trrrrip, .works__flower, .works__towel, .works__jobchange, .works__piza, .about__heading, .about__contents, .about__area,.contact",
