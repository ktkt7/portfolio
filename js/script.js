...
$(function (){
    ...
    { delay: 400,origin:"top" ,distance:"10px" });
    ScrollReveal().reveal('.works__title , .works_subtitle , .works__contents-hr, .works__imgtext', 
    { delay: 300, origin: "left", distance: "5px" });
    ScrollReveal().reveal('.works_top-hr  , .circle', 
    { delay: 300, origin: "right", distance: "5px" });
    ScrollReveal().reveal('.works__portfolio, .works__salon, .works__designcafe, .works__workers,.works__humberger,.works__trrrrip,.about__heading,.about__contents,.about__area,.contact', 
    { delay: 300 , origin:"bottom" ,distance:"40px"});

    //about.html

    ScrollReveal().reveal('.mabout__main__heading ', 
    { delay: 200 , origin:"bottom", distance:"50px" });
    ScrollReveal().reveal('.about__main__contents ,.about__skill__contents', 
    { delay: 200 , origin:"bottom", distance:"50px" });
    ScrollReveal().reveal('.about__skill__top-hr , .about__career__title , .about__career__subtitle' ,
    { delay: 200, origin: "left", distance: "10px" });
    ScrollReveal().reveal('.about__skill__title  , .about__skill__subtitle,.about__career__top-hr', 
    { delay: 200, origin: "right", distance: "10px" });
    ScrollReveal().reveal('.timeline li ', 
    { delay: 200 , origin:"top", distance:"50px" , interval:"200", reset:false});
